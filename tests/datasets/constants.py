...
TEST_METADATA_DOCUMENTS_DIRECTORY = TEST_RESOURCES_DIRECTORY / "metadata_documents"
...
TEST_COPY_VARIABLES_FILEPATH = TEST_METADATA_DOCUMENTS_DIRECTORY / "copy_variables.json"
