...
from dapla_metadata.datasets.compatibility._handlers import handle_version_6_1_1
from dapla_metadata.datasets.compatibility._handlers import handle_version_6_1_2
...
BackwardsCompatibleVersion(version="6.1.1", handler=handle_version_6_1_1)
BackwardsCompatibleVersion(version="6.1.2", handler=handle_version_6_1_2)
BackwardsCompatibleVersion(version="6.2.0", handler=handle_current_version)
