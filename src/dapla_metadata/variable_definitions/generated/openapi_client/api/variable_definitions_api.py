...
class VariableDefinitionsApi:
    ...
    def get_public_variable_definition_by_id_0(
        ...
        accept_language: Annotated[SupportedLanguages, Field(description="Render the variable definition in the given language.")],
        date_of_validity: Annotated[Optional[date], Field(description="List only variable definitions which are valid on this date.")] = None,
    ...
    def list_public_variable_definitions_0(
        self,
        accept_language: Annotated[SupportedLanguages, Field(description="Render the variable definition in the given language.")],
        date_of_validity: Annotated[Optional[StrictStr], Field(description="List only variable definitions which are valid on this date.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
