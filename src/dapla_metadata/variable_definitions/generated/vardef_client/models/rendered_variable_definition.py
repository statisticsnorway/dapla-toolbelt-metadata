...
class RenderedVariableDefinition(BaseModel):
    ...
    classification_uri: Optional[StrictStr] = None
    unit_types: List[Optional[KlassReference]]
    subject_fields: List[Optional[KlassReference]]
    contains_special_categories_of_personal_data: StrictBool
    measurement_type: Optional[KlassReference] = None
    valid_from: date
    valid_until: Optional[date] = None
    external_reference_uri: Optional[StrictStr] = None
    comment: Optional[StrictStr] = None
    related_variable_definition_uris: Optional[List[StrictStr]] = None
    contact: Optional[RenderedContact] = None
    last_updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "patch_id", "name", "short_name", "definition", "classification_uri", "unit_types", "subject_fields", "contains_special_categories_of_personal_data", "measurement_type", "valid_from", "valid_until", "external_reference_uri", "comment", "related_variable_definition_uris", "contact", "last_updated_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.classification_uri is None and "classification_uri" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit_types": [KlassReference.from_dict(_item) for _item in obj["unit_types"]] if obj.get("unit_types") is not None else None,
            "subject_fields": [KlassReference.from_dict(_item) for _item in obj["subject_fields"]] if obj.get("subject_fields") is not None else None,
            "contains_special_categories_of_personal_data": obj.get("contains_special_categories_of_personal_data"),
            "measurement_type": KlassReference.from_dict(obj["measurement_type"]) if obj.get("measurement_type") is not None else None,
            ...
            "contact": RenderedContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
