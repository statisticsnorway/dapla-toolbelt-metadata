...
class Draft(BaseModel):
    ...
    contains_special_categories_of_personal_data: StrictBool = Field(description="True if variable instances contain particularly sensitive information. Applies even if the information or identifiers are pseudonymized. Information within the following categories are regarded as particularly sensitive: Ethnicity, Political alignment, Religion, Philosophical beliefs, Union membership, Genetics, Biometrics, Health, Sexual relations, Sexual orientation")
    ...
    __properties: ClassVar[List[str]] = ["name", "short_name", "definition", "classification_reference", "unit_types", "subject_fields", "contains_special_categories_of_personal_data", "measurement_type", "valid_from", "external_reference_uri", "comment", "related_variable_definition_uris", "contact"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contains_special_categories_of_personal_data": obj.get("contains_special_categories_of_personal_data") if obj.get("contains_special_categories_of_personal_data") is not None else False,
